imagenet_resnet50 = {
  ...
  'sim_speedup' : 0.2 # speedup relative to wall-clock time
}
...
llama_8b_wikipedia = {
  ...
  'sim_speedup' : 1.0 # 1.0x speedup relative to wall-clock time
}
...
llama_8b_commoncrawl = {
  ...
  'sim_speedup' : 400 # 1.0x speedup relative to wall-clock time
}